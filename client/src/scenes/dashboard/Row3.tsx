        ...
        <>
            ...
            <DashboardBox gridArea="j">
                ...
                <Typography margin="0 1rem" variant="h6">
                    Remember to always keep track of your data to be up to date on the enviroment that you are using this application for. Staying up to date on daily data can have postive impacts for you and others using your service.
                </Typography>
            </DashboardBox>
        </>
    )
